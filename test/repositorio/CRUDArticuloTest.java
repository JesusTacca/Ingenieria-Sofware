...
public class CRUDArticuloTest {
    ...
    /**
     * Test of getPdfVOById method, of class CRUDArticulo.
     */
    @Test
    public void testGetPdfVOById() {
        System.out.println("getPdfVOById");
        int studentId = 0;
        CRUDArticulo instance = new CRUDArticulo();
        Articulo expResult = null;
        Articulo result = instance.getPdfVOById(studentId);
        assertEquals(expResult, result);
    }

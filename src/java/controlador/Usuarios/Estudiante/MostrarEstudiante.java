...
public class MostrarEstudiante extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    CrudEstudiante crud= new CrudEstudiante();
            ArrayList<Estudiante> verEstud = new ArrayList<>();
            verEstud = crud.getAllEstudiantes();
    
            request.getSession().setAttribute("verEstud", verEstud);
            response.sendRedirect("adm/Estudiante.jsp");  
  }
